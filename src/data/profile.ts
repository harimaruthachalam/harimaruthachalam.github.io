...
export const profile = {
   ...
   */
  about:
    "Chief Technology Officer at Qumin.ai, where I lead the engineering and ML organisation behind two agentic AI products — custom LLM orchestration, computer vision, and autonomous end-to-end testing. Before that: five years of applied data science across automotive safety at Netradyne and healthcare at ZS Associates, three years of academic research at IIT Madras, and a software engineering foundation from Cognizant. I work end to end — from problem framing to edge deployment — with a bias toward shipping systems that hold up in production, not just on a leaderboard.",
  /**
   ...
   */
  longBio:
    "Srihari Maruthachalam is an Indian machine learning leader, data scientist, and researcher. He is the Chief Technology Officer of Qumin.ai in Bengaluru, a position he has held since March 2026, where he leads the technology organisation behind two agentic AI products with a team of four engineers, owning architecture, ML strategy, infrastructure, and delivery end to end. Before Qumin he served as Staff Data Scientist at Netradyne, the AI-powered fleet safety company in Bengaluru, from June 2022 through June 2025, and as a Data Science Associate Consultant at ZS Associates from April 2020 through June 2022. He holds an MS by Research in Computer Science and Engineering from the Indian Institute of Technology, Madras (CGPA 8.0/10), where he was advised by Prof. Hema A. Murthy and worked on EEG signal processing and brain–computer interfaces. He earned his B.Tech in Information Technology from Anna University, Chennai (CGPA 8.2/10), and ranked in the top 1.5% nationally in the 2016 Graduate Aptitude Test in Engineering (GATE).\n\n" +
    "At Qumin.ai, Maruthachalam drives an AI-powered no-code QA platform (nocode.qumin.ai) that converts plain-English test cases into autonomous end-to-end tests. He designed its custom agent orchestration engine — built without off-the-shelf agent frameworks — in which an LLM plans and executes user journeys through a Playwright execution layer while a vision and OCR pipeline interprets the rendered UI the way a human would, making tests resilient to DOM and layout changes. He engineered the entire agent loop to run reliably on Gemini 3.1 Flash Lite, achieving frontier-grade test accuracy at a fraction of typical inference cost, which is the platform's core technical moat; the system is deployed on AWS, and he additionally architected an Android QA platform extending agentic testing to mobile. He also expanded the company into chat-first sales prospecting (qumin.ai), where a natural-language prompt is converted into an explicit ideal customer profile, after which autonomous research agents mine the open web for buying signals such as funding, hiring, and technology adoption, enrich and cross-verify contacts with confidence scores, and stream source-backed evidence into a live human-in-the-loop workspace built on the same custom orchestration stack.\n\n" +
